...
/**
 * Offline OCR via ML Kit's bundled Latin recognizer. Every OCR screen in the app calls
 * through here. (Malayalam/Arabic support via Tesseract, and the per-scan language chooser,
 * were removed to cut APK size — English/Latin is the only script read now.)
 */
object TextOcr {
